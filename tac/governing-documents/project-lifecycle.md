...
## Criteria Breakup and Evaluation
...
![alt text](./project-lifecycle-transition-criteria.png)

The groups of criteria marked in green indicate that a project is ready to make an upgrade transition, or is qualified to maintain its stage. The decisiosn is at the TAC's discretion.
